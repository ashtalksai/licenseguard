      ...
      <div className="hidden lg:flex flex-col justify-center bg-brand-navy p-12 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-md">
          ...
          <p className="text-gray-300 text-lg leading-relaxed mb-8">
            Join 500+ practice managers who know their team&apos;s compliance
            status at a glance.
          </p>
          ...
          <div className="mt-12 bg-white/10 rounded-xl p-6 border border-white/10">
            <p className="text-gray-200 italic text-sm leading-relaxed">
              &ldquo;The dashboard is exactly what I wanted. I open it Monday morning,
              see green across the board, and move on.&rdquo;
            </p>
            <p className="text-gray-400 text-xs mt-3">
              — Marcus T., Practice Manager, Austin TX
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="flex flex-col justify-center px-6 sm:px-12 lg:px-16 py-12 bg-background">
        ...
        >
          ...
          <p className="text-center text-sm text-muted-foreground mt-6">
            ...
            <Link
              href="/login"
              className="text-brand-navy font-medium hover:text-accent"
            >
              Log in
            </Link>
          </p>
